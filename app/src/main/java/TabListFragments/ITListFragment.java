...
public class ITListFragment extends Fragment {
    ...
    public void UpdateUI(){
        ...
        copyNotices=new ArrayList<>();
            ...
            for (Notice_info notice : notices) {
                if (Integer.parseInt(notice.getNoticeDept()) == 2 || (Integer.parseInt(notice.getNoticeDept()) == 4) || Integer.parseInt(notice.getNoticeDept()) == 6 ||Integer.parseInt(notice.getNoticeDept()) == 7&&(notice.getIsPlacement()==0)) {
        ...
        if(mAdapter==null) {                        //running for the first time
            ...
            mAdapter = new ITListFragment.NoticeAdapter(copyNotices);
    ...
    public  class NoticeHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void bindNotice(Notice_info notice){         //called in adapter
           ...
           // mSolvedCheckBox.setChecked(mNotice.isSeen());
        }
