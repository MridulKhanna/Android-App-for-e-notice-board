    ...
    public void UpdateUI(){
        ...
        copyNotices=new ArrayList<>();
            ...
            for (Notice_info notice : notices) {           //enhanced for loop without indices..notice here is variable used of Notice_info data type..operating on mNotice_info
                ...
                if (Integer.parseInt(notice.getNoticeDept()) == 1 || (Integer.parseInt(notice.getNoticeDept()) == 4) || Integer.parseInt(notice.getNoticeDept()) == 5 ||Integer.parseInt(notice.getNoticeDept()) == 7 &&(notice.getIsPlacement()==0)) {
        ...
        if(mAdapter==null) {                        //running for the first time
            ...
            mAdapter = new CompListFragment.NoticeAdapter(copyNotices);
