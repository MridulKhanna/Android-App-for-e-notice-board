package com.example.hp.pictconnect.TabListFragments;
...
public class  ENTCListFragment extends Fragment {
    ...
    public void UpdateUI(){
        ...
        copyNotices=new ArrayList<>();
            ...
            for (Notice_info notice : notices) {
                if (Integer.parseInt(notice.getNoticeDept()) == 3 || (Integer.parseInt(notice.getNoticeDept()) == 5) || Integer.parseInt(notice.getNoticeDept()) == 6 ||Integer.parseInt(notice.getNoticeDept()) == 7&&(notice.getIsPlacement()==0)) {
        ...
        if(mAdapter==null) {                        //running for the first time
            ...
            mAdapter = new ENTCListFragment.NoticeAdapter(copyNotices);
